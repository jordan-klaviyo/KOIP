...
const prompts = [
  ...
  `Your flow has been successfully created. You can find it by going to klayveeoh.com slash flow slash {{widgets.CreateFlow.parsed.id}} slash edit. Again the ID is {{widgets.CreateFlow.parsed.id}}. Enjoy setting up the rest of your flow! Bye bye!`,
  `Your segment is described as follows:
{{widgets.GenerateSegment.parsed.segment_description}}`,
`OK got it. Generating your flow now. This may take a few seconds.`
];
